 ...
 * @author Firdaus
 */
public class PenyewaPageService extends Repository {
   ...
   private Helper helper = new Helper();
    ...
    public void katalogShow(PenyewaPageView view, ArrayList<Kendaraan> kendaraan_data) throws SQLException, Exception {
        ...
        switch (kendaraan_data.size()) {
            ...
            case 1:
                ...
                helper.createAset(kendaraan1, view.getGambar1(), view.getHargaKendaraan1(),
            ...
            case 2:
                ...
                helper.createAset(kendaraan1, view.getGambar1(), view.getHargaKendaraan1(),
                        view.getMerkKendaraan1(), view.getJmlPenumpang1());
                helper.createAset(kendaraan2, view.getGambar2(), view.getHargaKendaraan2(),
            ...
            default:
                ...
                helper.createAset(kendaraan2, view.getGambar2(), view.getHargaKendaraan2(),
                        view.getMerkKendaraan2(), view.getJmlPenumpang2());
                helper.createAset(kendaraan3, view.getGambar3(), view.getHargaKendaraan3(),
    ...
    public void riwayatShow(PenyewaPageView view, ArrayList<Transaksi> transaksi_data) throws SQLException, Exception {
        ...
        switch (transaksi_data.size()) {
            ...
            case 1:
                ...
                helper.createAsetRiwayat(transaksi1, view.getImage(), view.getNamaKendaraan1(),
            ...
            default:
                ...
                helper.createAsetRiwayat(transaksi1, view.getImage(), view.getNamaKendaraan1(),
                        view.getTglMulai(), view.getTglSelesai(), view.getHargaSewa(), view.getStatus());
                helper.createAsetRiwayat(transaksi2, view.getImage1(), view.getNamaKendaraan2(),
    ...
    public int getPageKatalog() {
        int page =0;
        try {
            int totalData = getTotalDataKendaraan();
    ...
    public int getPageTransaksi(String username) {
        int page =0;
        try {
            int totalData = getTotalDataTransaksi(username);
